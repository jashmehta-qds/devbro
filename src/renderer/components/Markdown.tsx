    ...
    <div className={`prose-sm ${className}`}>
      <ReactMarkdown
        ...
        components={{
          ...
          a: ({ children, href }) => <a href={href} target="_blank" rel="noopener noreferrer" className="text-indigo-400 hover:text-indigo-300 underline">{children}</a>,
          ...
          code: ({ children, className }) => {
            ...
            if (isInline) return <code className="font-mono text-xs bg-gray-900 text-indigo-300 px-1 py-0.5 rounded">{children}</code>
